    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          placeholder="Tapşırıq haqqında qısa məlumat"
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="block text-text-secondary text-xs mb-1.5">Icraçı</label>
          <input
            value={form.assignee}
      ...
      <div>
        <label className="block text-text-secondary text-xs mb-1.5">Teqlər (vergüllə)</label>
        <input
          value={form.tags}
